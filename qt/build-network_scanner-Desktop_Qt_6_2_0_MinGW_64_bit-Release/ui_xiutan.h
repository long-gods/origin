/********************************************************************************
** Form generated from reading UI file 'xiutan.ui'
**
...
public:
    ...
    void setupUi(QMainWindow *xiutan)
    {
        if (xiutan->objectName().isEmpty())
            xiutan->setObjectName(QString::fromUtf8("xiutan"));
        xiutan->resize(1264, 766);
        QIcon icon;
        icon.addFile(QString::fromUtf8("../../neo.png"), QSize(), QIcon::Normal, QIcon::Off);
        xiutan->setWindowIcon(icon);
        action111 = new QAction(xiutan);
        action111->setObjectName(QString::fromUtf8("action111"));
        action111_2 = new QAction(xiutan);
        action111_2->setObjectName(QString::fromUtf8("action111_2"));
        centralwidget = new QWidget(xiutan);
        ...
        xiutan->setCentralWidget(centralwidget);
        menubar = new QMenuBar(xiutan);
        menubar->setObjectName(QString::fromUtf8("menubar"));
        menubar->setGeometry(QRect(0, 0, 1264, 21));
        xiutan->setMenuBar(menubar);
        statusbar = new QStatusBar(xiutan);
        statusbar->setObjectName(QString::fromUtf8("statusbar"));
        xiutan->setStatusBar(statusbar);

        retranslateUi(xiutan);
        QObject::connect(exitButton, &QPushButton::clicked, xiutan, qOverload<>(&QMainWindow::close));

        QMetaObject::connectSlotsByName(xiutan);
    } // setupUi

    void retranslateUi(QMainWindow *xiutan)
    {
        xiutan->setWindowTitle(QCoreApplication::translate("xiutan", "neosniffer", nullptr));
        action111->setText(QCoreApplication::translate("xiutan", "111", nullptr));
        action111_2->setText(QCoreApplication::translate("xiutan", "111", nullptr));
        nalabel->setText(QCoreApplication::translate("xiutan", "\351\200\211\346\213\251\347\275\221\345\215\241\357\274\232", nullptr));
        filterlabel->setText(QCoreApplication::translate("xiutan", "\350\277\207\346\273\244\350\247\204\345\210\231\357\274\232", nullptr));
        startButton->setText(QCoreApplication::translate("xiutan", "\345\274\200\345\247\213", nullptr));
        stopButton->setText(QCoreApplication::translate("xiutan", "\345\201\234\346\255\242", nullptr));
        exitButton->setText(QCoreApplication::translate("xiutan", "\351\200\200\345\207\272", nullptr));
        groupBox->setTitle(QCoreApplication::translate("xiutan", "static", nullptr));
        ip4label->setText(QCoreApplication::translate("xiutan", "IPv4\357\274\232", nullptr));
        ip6label->setText(QCoreApplication::translate("xiutan", "IPv6\357\274\232", nullptr));
        arplabel->setText(QCoreApplication::translate("xiutan", "ARP\357\274\232", nullptr));
        tcplabel->setText(QCoreApplication::translate("xiutan", "TCP\357\274\232", nullptr));
        udplabel->setText(QCoreApplication::translate("xiutan", "UDP\357\274\232", nullptr));
        icmplabel->setText(QCoreApplication::translate("xiutan", "ICMP\357\274\232", nullptr));
        httplabel->setText(QCoreApplication::translate("xiutan", "HTTP\357\274\232", nullptr));
        otherlabel->setText(QCoreApplication::translate("xiutan", "\345\205\266\344\273\226\357\274\232", nullptr));
        aboutButton->setText(QCoreApplication::translate("xiutan", "\345\205\263\344\272\216", nullptr));
    } // retranslateUi

};

namespace Ui {
    class xiutan: public Ui_xiutan {};
} // namespace Ui
